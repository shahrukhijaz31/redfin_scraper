...
column_header = ['Price', 'Beds', 'Baths', 'URL', 'Sqft', 'Address', 'State', 'Zip_code', 'Sold Description']

print("There are {} pages in the options".format(pages))

for i in range(1, int(pages)+1):
    print('{}/page-{}'.format(main_url, i))
...
with open('redfin.csv', 'w', encoding='UTF8', newline='') as f:
    ...
    for property_url in property_urls:
        try:
            ...
            # Sqft
            square_ft = tree.xpath("//*[@class='stat-block sqft-section'][1]/span/text()")            
            ...
            data_to_write = [price, beds, baths, url_object, square_ft, address, state, zip_code, sold_class]
